...
const ProjectCard = ({  image, tech1, tech2, tech3, tech4, title, }: Props) => {
    return (
        <div className="grid w-[80%] mx-auto pt-[1rem] grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
                ...
                <p className="text-white opacity-65 text-[15px] mt-[1rem]">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Accusamus vero dignissimos cum omnis quae nam error a nobis voluptate? Ex laboriosam vel quis sapiente excepturi, perferendis natus impedit ratione perspiciatis.
                </p>
                <div className="mt-[1.3rem] grid-cols-2 grid sm:grid-cols-2 xl:grid-cols-4 gap-[2rem]">
