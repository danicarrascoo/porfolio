...
const ServiceCard = ({ num, title}: Props) => {
    const IconComponent =
    (icomMapping as Record<string, React.ElementType>)[num] || CommandLineIcon;
    
    return <div className="bg-black custom__service z-[100] relative transform rounded-2xl text-center p-6 shadow-md"> 
        ServiceCard
        </div>;
};
